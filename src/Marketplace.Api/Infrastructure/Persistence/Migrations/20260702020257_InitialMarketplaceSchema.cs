        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnonymousKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cnpj = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    BranchOfActivity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FantasyName = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardOwnerName = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: false),
                    ExpirationDate = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SimilarProducts", x => new { x.ParentProductId, x.ChildProductId });
                    table.ForeignKey(
                        name: "FK_SimilarProducts_Products_ChildProductId",
                        column: x => x.ChildProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SimilarProducts_Products_ParentProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SimilarProducts_ChildProductId",
