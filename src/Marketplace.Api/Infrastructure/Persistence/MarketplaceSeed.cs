...
public static class MarketplaceSeed
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var products = new[]
        {
            DemoProduct(musicSellerId, subCategories["Guitarras"], "DEMO-GUIT-FENDER", "Guitarra Fender Standard Telecaster Mexicana Black", "A Fender traz a Standard Telecaster para guitarristas que apreciam estilo e versatilidade por um super valor.", 5690.99m, 7, true, "/uploads/products/fender-american-especial-stratocaster-maple2-color-sunburst2012.jpg", "/uploads/products/fender-mex-black-014-5102-506.jpg"),
            DemoProduct(musicSellerId, subCategories["Guitarras"], "DEMO-GUIT-JACKSON", "Guitarra Jackson Monarkh JS22 Transparent Black", "Modelo com captadores humbucker, escala confortavel e acabamento moderno para rock e metal.", 3299.90m, 5, true, "/uploads/products/1094938_guitarra-jackson-monarkh-js22-585-transparent-black-ms_z1_637387173152514626.jpg"),
            DemoProduct(musicSellerId, subCategories["Violoes"], "DEMO-VIOL-TAGIMA", "Violao Tagima Dallas Tuner Eletroacustico", "Violao com afinador embutido, cordas de aco e otima resposta para estudo e palco.", 899.90m, 11, true, "/uploads/products/1090123_violao-tagima-dallas-tuner-eletrico-cordas-de-aco-e-com-afinador-ms_z2_637371635447323128.jpg"),
            DemoProduct(musicSellerId, subCategories["Baixos"], "DEMO-BAIXO-IBANEZ", "Baixo Ibanez RG 7420Z", "Instrumento versatil para linhas pesadas, com excelente sustain e acabamento robusto.", 2890.00m, 3, false, "/uploads/products/Ibanez-RG-7420Z.jpg"),
            DemoProduct(techSellerId, subCategories["Tecnologia"], "DEMO-LIVRO-CLEAN-ARCH", "Arquitetura Limpa", "Guia pratico para estrutura, design e manutencao de software profissional.", 66.33m, 20, true, "/uploads/products/clean-architecture.jpg"),
            DemoProduct(techSellerId, subCategories["Tecnologia"], "DEMO-LIVRO-CLEAN-CODE", "Codigo Limpo", "Boas praticas para escrever codigo legivel, testavel e sustentavel.", 79.90m, 15, true, "/uploads/products/clean-code-1.jpg"),
            DemoProduct(techSellerId, subCategories["Agilidade"], "DEMO-LIVRO-CLEAN-AGILE", "Clean Agile", "Uma introducao direta aos principios ageis aplicados em times modernos.", 58.50m, 8, false, "/uploads/products/clean_agile.jpg"),
            DemoProduct(techSellerId, subCategories["Notebooks"], "DEMO-NOTE-ACER-PREDATOR", "Notebook Acer Predator Helios 300", "Notebook gamer com alto desempenho para jogos, desenvolvimento e criacao.", 7499.00m, 4, true, "/uploads/products/Acer-Predator-Helios-300-PH315-52-748u.jpg"),
            DemoProduct(adminId, subCategories["Refrigerantes"], "DEMO-COCA-ZERO", "Coca-Cola Zero 350ml", "Bebida gelada para acompanhar suas compras e momentos de lazer.", 4.99m, 60, false, "/uploads/products/cocacola_zero_350ml.jpg"),
            DemoProduct(adminId, subCategories["Bicicletas"], "DEMO-BIKE-FOXER", "Bicicleta Foxer Aro 26", "Bicicleta resistente para uso urbano e passeios de fim de semana.", 1199.90m, 6, true, "/uploads/products/910061_bici_foxer_aro26_1_z.jpg")
        };
        ...
        IReadOnlyDictionary<string, int> attributes)
    {
        ...
        return variation switch
        {
            0 => ProductWithAttributes(
                ...
                index,
                $"/uploads/products/{(index % 2 == 0 ? "fender-mex-black-014-5102-506.jpg" : "1094938_guitarra-jackson-monarkh-js22-585-transparent-black-ms_z1_637387173152514626.jpg")}",
                attributes,
                brand,
                $"ST-{index:0000}",
                color,
            ...
            1 => ProductWithAttributes(
                ...
                520m + (index % 70 * 12.9m),
                index,
                "/uploads/products/1090123_violao-tagima-dallas-tuner-eletrico-cordas-de-aco-e-com-afinador-ms_z2_637371635447323128.jpg",
                attributes,
                "Tagima",
                $"DAL-{index:0000}",
                color,
            ...
            2 => ProductWithAttributes(
                ...
                49m + (index % 35 * 2.75m),
                index,
                index % 2 == 0 ? "/uploads/products/clean-code-1.jpg" : "/uploads/products/clean-architecture.jpg",
                attributes,
                "Alta Books",
                $"BOOK-{index:0000}",
                "Capa colorida",
            ...
            3 => ProductWithAttributes(
                ...
                3990m + (index % 120 * 45m),
                index,
                "/uploads/products/Acer-Predator-Helios-300-PH315-52-748u.jpg",
                attributes,
                "Acer",
                $"PH-{index:0000}",
                "Preto",
            ...
            4 => ProductWithAttributes(
                ...
                890m + (index % 60 * 18m),
                index,
                "/uploads/products/910061_bici_foxer_aro26_1_z.jpg",
                attributes,
                "Foxer",
                $"FX-{index:0000}",
                color,
            ...
            5 => ProductWithAttributes(
                ...
                index,
                "/uploads/products/cocacola_zero_350ml.jpg",
                attributes,
                "Coca-Cola",
                $"CZ-{index:0000}",
                "Lata",
            ...
            6 => ProductWithAttributes(
                ...
                1790m + (index % 80 * 25m),
                index,
                "/uploads/products/Ibanez-RG-7420Z.jpg",
                attributes,
                "Ibanez",
                $"RG-{index:0000}",
                color,
            ...
            _ => ProductWithAttributes(
                ...
                39m + (index % 40 * 2.3m),
                index,
                "/uploads/products/clean_agile.jpg",
                attributes,
                "Robert C. Martin",
                $"AGILE-{index:0000}",
                "Capa brochura",
    ...
    private static Product DemoProduct(
        ...
        new()
        {
            ...
            Stock = stock,
            Sku = sku,
            Images = images.Select(image => new ProductImage { FileName = image }).ToList()
        };
